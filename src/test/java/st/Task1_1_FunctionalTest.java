...
//			
//			parser.parse("--op1=f");11. Note that we utilize an enum for types - as only the typesSTRING, INTEGER, CHARACTER and BOOLEAN
//			are valid. NOTYPE is not considered a valid type, and exists for verification purposes.
//			These are important keywords for the parsing procedure, and using them as strings will lead to undefined
//			behavior.
//			
