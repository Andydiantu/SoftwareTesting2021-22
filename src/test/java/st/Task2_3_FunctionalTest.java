...
public class Task2_3_FunctionalTest {
	...
	public void booleanAssignmentTest() {
		parser.addOption(new Option("big", Type.STRING), "the");
	...
	@Test
	public void booleanAssignmentTest2() {
		parser.addOption(new Option("big", Type.STRING), "the");
	...
	@Test
	public void booleanAssignmentTest3() {
		parser.addOption(new Option("big", Type.BOOLEAN), "the");
	...
	public void longOptionNameTest() {
		...
		public void emptyParseTest() {
			...
			parser.parse("--op1=             --op2=txt");
			
		}
		
		@Test
		public void emptyParseTest2() {
			parser.addOption(new Option("op1", Type.STRING), "st");
		...
		@Test (expected = RuntimeException.class)
		public void getIntegerNameNotExistTest() {
			parser.getInteger("--blablabla");
		}
		
		@Test (expected = RuntimeException.class)
		public void getIntegerShortcutNotExistTest() {
			parser.getInteger("-blablabla");
		}
	...
	public void optionNotEqualTest() {
		...
		@Test
		public void optionNotEqualTypeTest() {
			Option option = new Option("op1", Type.STRING);
			Option option2 = new Option("op1", Type.BOOLEAN);
		...
		@Test (expected = NullPointerException.class)
		public void optionNotEqualClassTest() {
			Option option = new Option("op1", Type.STRING);
			Option option2 = new Option(null, Type.STRING);
			
			
			assertFalse(option.equals(option2));
			assertFalse(option2.equals(option));
			assertFalse(option2.equals(option2));
		}
